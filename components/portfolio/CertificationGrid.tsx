...
export function CertificationGrid() {
  return (
    <section id="certifications" className="ai-section relative z-[2]">
      <div className="ai-container max-w-6xl">
        <SectionTitle icon={Award} subtitle="Industry credentials across cloud, AI, data science, and web development.">
          Certifications
        </SectionTitle>
